...
✧ HII I'M SCOTCH ✧ @${num.split("@")[0]},
✧ Welcome To ${metadata.subject}

✧ Description: ${metadata.desc}

✧ HELLO DEAR WELCOME THANK YOU FOR JOINING PLEASE FOLLOW RULES HAVE A GOOD DAY 💜💫💌, Full Of Love, HOME`} )
                } else if (anu.action == 'remove') {
                    GojoMdNx.sendMessage(anu.id, { image: Tol, contextInfo: { mentionedJid: [num] }, caption: `✧ @${num.split("@")[0]} Left ${metadata.subject}

✧ Sayonara Join Again If You Have To Come. But It Was Fun While It Lasted 😌✨` })
                }
            }
        } catch (err) {
            console.log(err)
